...
import { ads, create_ads } from "../constants/routes";
...
class Ads_new extends Component {
  state = {
    visible: false,
    title: "",
    description: "",
  ...
  handleSubmit = async (e) => {
    ...
    const cover_url = await uploadFile(cover);
    ...
    const request_details = {
      type: POST,
      url: service_api,
      route: ads + "/" + create_ads,
      data: { ...data, cover: cover_url.data.url },
      token: token
    };
