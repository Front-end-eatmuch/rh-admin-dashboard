...
class Permission_new extends Component {
  state = { visible: false, name: "", list: [], role: "", load: true };
  ...
  handleSubmit = async (e) => {
    ...
    const request_details = {
      type: POST,
      url: service_api,
      route: permission + "/" + create_permission,
      data: data,
      token: token
    };
    ...
    return (
      <>
        <Button type="primary" onClick={this.showDrawer}>
          <PlusOutlined /> Crée permission
        </Button>
        <Drawer
          title="Creation de permission"
          width={720}
