...
import { role, get_all_role, delete_role } from "../constants/routes";
...
class AdminRole extends Component {
  ...
  getData = async () => {
    ...
    this.setState({ load: false, data: decryptSingleData(response.data.role) });
  };
    ...
    return (
      <>
        <PageHeader
          ...
          title="Roles"
          tags={<Tag color="blue">Liste des roles</Tag>}
          subTitle=""
          extra={[<Role_new />]}
        >
          <Row>
...
export default connect(mapStateToProps, mapDispatchStoreToProps)(AdminRole);
